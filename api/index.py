...
# Make Milvus optional for deployment - will be handled gracefully in functions
if not MILVUS_URI:
    print("⚠️  WARNING: MILVUS_URI not set - Milvus features will be disabled")
if not MILVUS_TOKEN:
    print("⚠️  WARNING: MILVUS_TOKEN not set - Milvus features will be disabled")
